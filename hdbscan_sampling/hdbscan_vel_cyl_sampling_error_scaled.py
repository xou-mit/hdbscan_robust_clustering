...
# those axes.
# Do not use PCA!
# XO note on 02/09/2022: Modified slightly to manually rescale all uncertainties 10 times slower to see if it affects
# the stability of the clustering result
...
ydata_err = (np.array(ydata_ini_err).T)/10 # Manually rescaled 10 times smaller
