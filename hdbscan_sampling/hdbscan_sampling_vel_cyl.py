...
# Expected input: python filename.py zmax_cut rel_err_cut N_samp min_samples min_cluster_size data_dir [plots_dir]
...
for i in range(N_samp):
    ...
    if algorithm == 'HDBSCAN':
        ...
        f.savefig(plots_dir + 'clustering' + extratext + '_samp_' + str(i) + '_tree' + '.png')
