...
# Expected input: python filename.py input_ind_date_file N_stack [N_samp - ignored] min_samples min_cluster_size data_dir [plots_dir]
...
#         ydata_samp[:,j] = np.random.normal(ydata[:,j], ydata_err[:,j])
    ...
    if algorithm == 'HDBSCAN':
        ...
        f.savefig(plots_dir + 'clustering' + extratext + '_tree' + '_baseline' + '.png')
